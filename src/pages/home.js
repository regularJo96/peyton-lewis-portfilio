    ...
    <div id="home" className="d-flex flex-column">
      ...
      <div className="position-relative block container-fluid bg-dark text-center justify-content-center text-light">
        ...
        <div className="container-fluid">
          <Welcome/>
          <Icon jumpTo="You're-a-Good-Man-Charlie-Brown" class="text-light" iconName="arrow_downward" position="bottom-12" title="You're a Good Man Charlie Brown"/>
        </div>
      </div>
      ...
      <div id="You're-a-Good-Man-Charlie-Brown" className="position-relative block container-fluid bg-snoopy text-center justify-content-center text-dark peanuts-font">
        ...
        <Icon jumpTo="Some-of-My-Best-Friends-are-Smiths" class="text-dark" iconName="arrow_downward" position="bottom-12" title="Some of My Best Friends are Smiths"/>
      ...
      <div id="Roald-Dahl's-Willy-Wonka" className="position-relative block container-fluid bg-purple text-center justify-content-center text-wonka willywonka-font">
        ...
        <Icon jumpTo="Curious-Savage" class="text-wonka" iconName="arrow_downward" position="bottom-12" title="Curious Savage"/>
      </div>
      ...
      <div id="Curious-Savage" className="position-relative block container-fluid bg-ethel text-center justify-content-center text-ethelC">
        <Icon jumpTo="Roald-Dahl's-Willy-Wonka" class="text-ethelC" iconName="arrow_upward" position="top-0" title="Roald Dahl's Willy Wonka"/>
        <div className="position-absolute top-0 start-0">
        ...
        <Icon jumpTo="The-Sound-of-Music" class="text-ethelC" iconName="arrow_downward" position="bottom-12" title="The Sound of Music"/>
      </div>
      ...
      <div id="The-Sound-of-Music" className="position-relative block container-fluid bg-green text-center justify-content-center text-light">
        <Icon jumpTo="Curious-Savage" class="text-light" iconName="arrow_upward" position="top-0" title="Curious Savage"/>
        <div className="position-absolute top-0 start-0">
        ...
        <Icon jumpTo="Anatomy-of-Gray" class="text-light" iconName="arrow_downward" position="bottom-12" title="Anatomy of Gray"/>
      </div>
      ...
      <div id="Anatomy-of-Gray" className="position-relative block container-fluid bg-dark text-center justify-content-center text-light">
        <Icon jumpTo="The-Sound-of-Music" class="text-light" iconName="arrow_upward" position="top-0" title="The Sound of Music"/>
        <div className="position-absolute top-0 start-0">
          <Menu class="text-light"/>
        </div>
        ...
        <Icon jumpTo="Don't-Be-Afraid-of-the-Dark" class="text-light" iconName="arrow_downward" position="bottom-12" title="Don't Be Afraid of the Dark"/>
      </div>
      ...
      <div id="Don't-Be-Afraid-of-the-Dark" className="position-relative block container-fluid bg-red text-center justify-content-center text-light">
        <Icon jumpTo="Anatomy-of-Gray" class="text-light" iconName="arrow_upward" position="top-0" title="Anatomy of Gray"/>
        <div className="position-absolute top-0 start-0">
          <Menu class="text-light"/>
        </div>
