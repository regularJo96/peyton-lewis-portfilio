  ...
  const block = (
    <>
      <div className="d-flex flex-column bg-green">
        <Link to="/plportfolio" coords="[0,0]" className="sticky-top"><Back class="text-light"/></Link>
        ...
        <div className="music-gallery">
          ...
          <img className="img-fluid m-pic-2 border border-light border-2 m-auto" src={pictures[14]}/>
        </div>
